      ...
      return (
        <DefaultLayout>
          ...
          <div className='page' data-wio-id={this.props.doc.id}>
            <Header menu={this.props.menu} page={this.props.uid} lang={this.props.lang} />
            <SliceZone sliceZone={this.props.doc.data.page_content} uid={this.props.uid} lang={this.props.lang} />
          </div>
          <style jsx global>{`
          body {
